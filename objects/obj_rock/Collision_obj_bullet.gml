...
if(obj_game.powerup_time < 0){	/// @DnDAction : YoYo Games.Random.Choose
	...
	/// @DnDArgument : "option_3" "obj_powerup_health"
	obj = choose(obj_powerup_ghost, obj_powerup_spread, obj_powerup_freeze, obj_powerup_health);
...
if(sprite_index == spr_rock_big){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	/// @DnDHash : 0511FE5F
	/// @DnDParent : 3BE03CA5
	/// @DnDArgument : "expr" "obj_game.rock_niv + 1"
	/// @DnDArgument : "var" "obj_game.rock_niv"
	obj_game.rock_niv = obj_game.rock_niv + 1;}

/// @DnDAction : YoYo Games.Common.If_Variable
/// @DnDVersion : 1
/// @DnDHash : 660D9A22
/// @DnDArgument : "var" "obj_game.rock_niv"
/// @DnDArgument : "value" "6 * obj_game.level"
if(obj_game.rock_niv == 6 * obj_game.level){	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
	/// @DnDHash : 49F6519A
	/// @DnDInput : 2
	/// @DnDParent : 660D9A22
	/// @DnDArgument : "expr_1" "obj_game.level +1"
	/// @DnDArgument : "var" "obj_game.rock_niv"
...
/// @DnDHash : 496CA5D0
	...
	/// @DnDArgument : "op" "1"
	/// @DnDArgument : "value" "12 * obj_game.level"
	if(instance_number(obj_rock) < 12 * obj_game.level){	/// @DnDAction : YoYo Games.Loops.Repeat
		/// @DnDVersion : 1
		/// @DnDHash : 1C3B2E04
		/// @DnDParent : 4D0A6476
		/// @DnDArgument : "times" "obj_game.level"
		repeat(obj_game.level){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
			/// @DnDVersion : 1
			/// @DnDHash : 01096573
			/// @DnDParent : 1C3B2E04
